...
//     let prepTimeMinutes = totaltime(item.more.prep_time);
//     let cookTimeMinutes = totaltime(item.more.cook_time);
...
//                         An easy and quick dish, perfect for any meal. This classic omelette combines eggs cooked to perfection, optionally filled with your choice of cheese, vegetables, or meats.
//                     </p>
//                 </div>
...
//                         <h2 className="text-3xl font-semibold text-gray-900 mb-4">Ingredients</h2>
...
//                     {/* Preparation Time */}
//                     <div className="bg-white rounded-xl shadow-lg p-6">
//                         <h2 className="text-3xl font-semibold text-gray-900 mb-4">Preparation Time</h2>
//                         <ul className="space-y-3">
//                             <li className="flex justify-between text-lg text-gray-700">
//                                 <span className="font-medium text-gray-600">Total Time:</span>
//                                 <span className="font-bold text-gray-800">{Total ?? "25Min"} minutes</span>
//                             </li>
//                             <li className="flex justify-between text-lg text-gray-700">
//                                 <span className="font-medium text-gray-600">Preparation Time:</span>
//                                 <span className="font-bold text-gray-800">{item?.more?.prep_time ?? "15Min"}</span>
//                             </li>
//                             <li className="flex justify-between text-lg text-gray-700">
//                                 <span className="font-medium text-gray-600">Cooking Time:</span>
//                                 <span className="font-bold text-gray-800">{item?.more?.cook_time ?? "10Min"}</span>
//                             </li>
//                         </ul>
//                     </div>
//                 </div>
...
//                     <h2 className="text-3xl font-semibold text-gray-900 mb-4">Instructions</h2>
