...
// var navigationData = ['Home','Recipes', 'About', 'Contact']
...
//   <ul className="flex space-x-4 sm:space-x-2 md:space-x-4 py-2 items-center"> {/* Responsive spacing */}
//     {navigationData.map((item, index) => (
//       <li key={index} className="hidden sm:block md:block lg:block"> {/* Hide on small screens */}
//        <Link
//   to={item === "Recipes" ? "/AllReceipe" :  item === "Home" ? "/" :  `${item}`}
...
// <li>
//   <button className="hidden sm:block md:block lg:block btn bg-blue-800 text-white hover:bg-blue-900 rounded-md items-center h-2 w-21">
//     Log In
//   </button>
// </li>
// <li>
...
//       </div>
//       <ul
//         className={`absolute top-full left-0 w-full bg-gray-800 py-4 px-6 sm:hidden ${
...
// const navigationData = ['Home', 'Recipes', 'About', 'Contact', 'Register'];
...
//             {navigationData.map((item, index) => (
//               <li key={index} className="hidden sm:block md:block lg:block">
//                 <Link
//                   to={item === "Recipes" ? "/AllReceipe" : item === "Home" ? "/" : `${item}`}
//                   className="text-white mt-0 hover:text-orange-400 hover:font-bold hover:underline"
//                 >
...
//             {isAuthenticated ? (
//               <>
//                 <li className="text-white">Hello, {userName}</li> {/* Show user's name */}
//                 <li>
