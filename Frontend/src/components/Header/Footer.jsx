...
<footer className="px-4 divide-y bg-gray-800 text-gray-100">
	...
	<div className="lg:w-1/3 ml-7">
  <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
    <div className="flex items-center justify-center w-16 h-16 rounded-full bg-violet-400">
      <img 
        src="https://static.vecteezy.com/system/resources/previews/012/671/106/large_2x/recipe-book-logo-design-template-vector.jpg" 
        alt="Recipe Book Logo" 
        className="w-16 h-16 rounded-full object-cover"
      />
    </div>
    <span className="self-center text-2xl font-semibold">Recipe</span>
  </a>
</div>
	...
	<div className="py-6 text-sm text-center text-gray-400">© 2025 Food Receipe. All rights reserved.</div>
</footer>
</>
  )
}
